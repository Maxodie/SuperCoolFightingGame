...
namespace SuperCoolFightingGame
{
    public class PlayerSelectorState : GameState{
        ...
        Text characterInfosSpecialDescription;
        ...
        public override void InitGUI()
        {
            ...
            characterInfosSpecialDescription = new Text(Color.White, new Vector2(48, 330), "", gameE.fonts["Pixel10"]);
            gameE.AddTextToRender(charactersInfosText);
            gameE.AddTextToRender(characterInfosSpecialDescription);
        }
        ...
        void SelectCharacter(object sender, EventArgs e, ButtonGUI currentIcon, Image newImage, Vector2 newImagePos, Vector2 pos, Type characterType) {
            ...
            charactersInfosText.ChangePos(new Vector2(48, 180));
            charactersInfosText.text = $"{characterData.Name}\n\nHP : {characterData.BaseHealth}   AP : {characterData.BaseAttack}\n\n{characterData.specialName} :";
            characterInfosSpecialDescription.text = $"{characterData.specialDescription}";
            ...
            if (startBtn == null) {
                ...
                Sprite shadow = new Sprite(imageLoader.GetImage("shadow"), new Rectangle(0, 0, 128, 40), new Vector2(328, 360));
